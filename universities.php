            ...
            <?php
				...
				if ($result->num_rows > 0) {
					...
					while ($row = $result->fetch_assoc()) {
						...
						echo '<a href="university.php?id=' . $row['id'] . '">';
						echo '<div class="card">';
						echo '<img src="' . $row['image_url_1'] . '" class="card-img-top" alt="' . $row['name'] . '" width="300" height="200">';
					...
					echo '<div class="alert alert-warning">No universities found.</div>';
				}
			?>
        </div>
    </div>
